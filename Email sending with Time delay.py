...
def send_email(smtp_server, smtp_port, smtp_username, smtp_password, from_email, to_email, subject, body):
    try:
        ...
        # Create the email
        msg = MIMEMultipart()
        msg['elayarajameenaloshini002@gmail.com'] = from_email
        msg['sit20ad009@sairamtap.edu.in'] = to_email
        msg['Test Email'] = subject
        msg.attach(MIMEText(body, 'This is a test email.'))
